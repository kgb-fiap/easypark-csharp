...
O repositório inclui uma coleção Postman (`EasyPark.postman_collection.json`) e um ambiente (`EasyPark.postman_environment.json`) que facilitam a experimentação da API:
